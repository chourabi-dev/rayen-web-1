            ...
            <div class="col-sm-9"> 
              ...
              <div class="row">
                <?php
                    ...
                    <div class="card mb-3">
                        <div class="card-body"> 
                         <p class="text-muted">'.$data['decription_article'].' Likes</p>
                        </div>
                    </div>
                    ...
                    <div class="card mb-5">
                        ...
                        <a href="like_article.php?id='.$data['id_article'].'&likes='.$data['likes'].'" class="btn btn-primary" style="width: 250px">'.$data['likes'].' Likes</a>
                       
                        <button class="btn btn-success" style="width: 250px">Buy</button>
