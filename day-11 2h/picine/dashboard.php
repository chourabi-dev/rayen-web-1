    ...
    while ($data = $reqCAT->fetch()) {
      ...
      <tr >
        ...
        <td>';
            ...
            if ($data['status'] == 0) {
              $usersBLOC.='<a href="accept_user.php?id='.$data['idusers'].'" class="btn btn-success btn-sm">accepter</a>';
            }
...
<html lang="en">
  ...
  <body>
        ...
        <div class="container mt-5">
          ...
          <div class="card mt-5">
           <div class="card-body">
             <iframe src="http://127.0.0.1/picine/index.php" width="100%" height="600px"></iframe>
